...
$(function() {
    ...
    var userChartData = UserAccessData

    userChartData.datasets[0].fillColor = 'rgba(60,141,188,0.9)'
    userChartData.datasets[0].strokeColor = 'rgba(60,141,188,0.8)'
    userChartData.datasets[0].pointColor = '#3b8bba'
    ...
    userChartOptions.datasetFill = false
    userChart.Bar(userChartData, userChartOptions)
})
</script>
